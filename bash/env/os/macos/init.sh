...
if [ ! -f "$DOTFILES_REPO_HOME/bash/env/completions/iterm2_shell_integration.bash" ]; then
  curl -L https://iterm2.com/shell_integration/bash \
    -o "$DOTFILES_REPO_HOME/bash/env/completions/iterm2_shell_integration.bash"
fi
