...
if [ ! -f "$SSH_CONFIG" ]; then
  echo "# Include generated by my dotfiles' setup/ssh/init.sh script on $(date)" >"$SSH_CONFIG"
  ...
  echo -e "# Include generated by my dotfiles' setup/ssh/init.sh script on $(date)\n$INCLUDE_LINE\n\n$(cat "$SSH_CONFIG")" >"$SSH_CONFIG"
